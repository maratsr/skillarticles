...
class RootViewModel @ViewModelInject constructor( // Через Hilt работаем
    @Assisted handle: SavedStateHandle, // Важно чтобы был import androidx.hilt.Assisted (рантайм SavedStateHandle передаем)
